...
from models.layers.activations import get_activation_from_name
from models.layers.normalizers import get_normalizer_from_name
...
def depthwise_separable_convolutional(inputs, out_dim, strides=(1, 1), alpha=1, depth_multiplier=1, activation="relu6", normalizer='batch-norm', prefix=None):
    ...
    x = get_activation_from_name(activation, name=f'conv_pw_{prefix}_activ')(x)
    return x
