"""
    ...
    # Notes:
        ...
        - The original Inception-ResNet-v1 architecture assumes a fixed input
        ...
        original Inception-ResNet-v1 architecture.
    ...
    General Model Architecture:
        ...
        |------------------------+-----------------------------+-------------------------|
        | CLS Logics             | GlobalAveragePooling2D      | (None, 1792)            |
        |                        | fc (Logics)                 | (None, 1000)            |
         --------------------------------------------------------------------------------
