from .arithmetic import (erasing, Erasing, RandomErasing,
...
from .blends import (blend_random_image, BlendRandomImage, RandomBlendRandomImage)
...
from .colors import (desaturate, Desaturate, RandomDesaturate,
